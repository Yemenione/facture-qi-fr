...
export default function InvoiceDetailsPage() {
    ...
    const downloadPdf = async () => {
        try {
            ...
            a.href = url;
            a.download = `${invoice.type === 'QUOTE' ? 'devis' : invoice.type === 'CREDIT_NOTE' ? 'avoir' : 'document'}-${invoice.invoiceNumber}.pdf`;
    ...
    const sendEmail = async () => {
        const typeName = invoice.type === 'QUOTE' ? 'le devis' : invoice.type === 'CREDIT_NOTE' ? 'l\'avoir' : 'le document';
